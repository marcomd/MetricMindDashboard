...
test.describe('Trends Page', () => {
  ...
  test('should display trends page with chart', async ({ page }) => {
    // Check page title
  ...
  test('should filter by repository', async ({ page }) => {
    ...
    const optionsBefore = await repoSelect.locator('option').count();
  ...
  test('should display chart cards with metrics', async ({ page }) => {
