...
function Overview() {
  ...
  const largestCommitsChartData = largest_commits.map(commit => ({
  ...
  const topContributorsChartData = top_contributors.map(contributor => ({
          ...
          <ResponsiveContainer width="100%" height={400}>
            <BarChart data={largestCommitsChartData}>
              ...
              <Bar dataKey="lines_changed" animationDuration={1000} radius={[8, 8, 0, 0]}>
                {largestCommitsChartData.map((entry, index) => (
          ...
          <ResponsiveContainer width="100%" height={400}>
            <BarChart data={topContributorsChartData} layout="vertical">
              ...
              <Bar dataKey="commits" animationDuration={1000} radius={[0, 8, 8, 0]}>
                {topContributorsChartData.map((entry, index) => (
                  <Cell key={`cell-${index}`} fill={barColors[index % barColors.length]} />
                ))}
              </Bar>
            </BarChart>
